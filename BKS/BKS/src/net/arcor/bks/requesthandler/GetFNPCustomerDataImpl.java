/*
    $Header:   //PVCS_BKS/archives/BKS/BKS/src/net/arcor/bks/requesthandler/GetFNPCustomerDataImpl.java-arc   1.106   Sep 17 2018 14:37:58   makuier  $

    $Log:   //PVCS_BKS/archives/BKS/BKS/src/net/arcor/bks/requesthandler/GetFNPCustomerDataImpl.java-arc  $
 * 
 *    Rev 1.106   Sep 17 2018 14:37:58   makuier
 * Support for Fibre services added
 * 
 *    Rev 1.105   Oct 27 2017 14:05:26   makuier
 * Added BIR to not supported bundle types.
 * 
 *    Rev 1.104   Jul 27 2017 12:48:22   makuier
 * Use service billing name fro volume cap
 * 
 *    Rev 1.103   Jun 08 2017 07:50:46   makuier
 * Return volume caps
 * 
 *    Rev 1.102   Jan 19 2017 15:51:08   makuier
 * Skip Intro for SID services
 * 
 *    Rev 1.101   Oct 28 2016 18:42:32   makuier
 * - trigger generic ref data for HW
 * 
 *    Rev 1.100   Sep 23 2016 12:28:54   makuier
 * Populate default value of 0 if the tariff option does not have any duration characteristic (V0231)
 * 
 *    Rev 1.99   Sep 21 2016 07:24:46   makuier
 * Consider product code in the address key.
 * 
 *    Rev 1.98   Jul 07 2016 15:42:24   lejam
 * RMS-152753 PPM-196371 DSL Portfolio 2016 - replaced service code by "minimumDuration" in tvcenteropions 
 * 
 *    Rev 1.97   Jul 07 2016 12:49:34   gaurav.verma
 * Add the node ContratualObligation
 * 
 *    Rev 1.96   Jun 30 2016 09:11:02   gaurav.verma
 * RMS-152753 PPM-196371 DSL Portfolio 2016 - Changes for TariffOptionList and TvCenterOptionList
 * 
 *    Rev 1.95   Dec 03 2015 21:33:24   sibani.panda
 * RMS 149627 PPM-183594 - Changed Error code and text in case of customer of a service provider
 * 
 *    Rev 1.94   Sep 15 2015 15:49:56   makuier
 * Support for rented hardware added.
 * 
 *    Rev 1.93   Jun 09 2015 16:33:20   sibani.panda
 * RMS-142618: added method populateCustomerPermissions for populating customer permissions details from new tables
 * 
 * *    Rev 1.93   June 09 2015 09:28:34   sibani
 * Added method populateCustomerPermissions
 * 
 *    Rev 1.92   Apr 02 2014 09:28:34   makuier
 * Check the validation row.
 * 
 *    Rev 1.91   Mar 17 2014 10:02:20   makuier
 * Separate email validation.
 * 
 *    Rev 1.90   Mar 06 2014 09:22:44   makuier
 * Do not populate EmailValidationResult if any mandatory sub node is missing
 * 
 *    Rev 1.89   Jan 22 2014 12:02:38   makuier
 * Populate mandate node only  if both mandatory sub-nodes are populated.
 * 
 *    Rev 1.88   Oct 10 2013 12:31:38   makuier
 * Populate bank node only  if both mandatory sub-nodes are populated.
 * 
 *    Rev 1.87   Jun 12 2013 11:17:52   makuier
 * Changed the serializer
 * 
 *    Rev 1.86   Oct 12 2012 13:58:38   makuier
 * Added V0012 to the list of services.
 * 
 *    Rev 1.85   Aug 22 2012 16:08:54   makuier
 * - Do not populate hot subscription if the characteristic is not populated
 * 
 *    Rev 1.84   Jul 19 2012 16:57:08   makuier
 * Populate Contract end date
 * 
 *    Rev 1.83   Jun 22 2012 14:05:34   makuier
 * Populate log table
 * 
 *    Rev 1.82   May 04 2012 13:49:06   makuier
 * Do not raise BKS-00026 for DSL-R products
 * 
 *    Rev 1.81   Apr 19 2012 10:23:32   makuier
 * Allow conversion method for access numbers.
 * 
 *    Rev 1.80   Apr 13 2012 11:11:04   makuier
 * I1351 added to the list of TV add-ons
 * 
 *    Rev 1.79   Mar 29 2012 15:14:56   makuier
 * remove duplicates from customer list
 * 
 *    Rev 1.78   Mar 26 2012 12:25:00   makuier
 * Parsing phone number in contact medium supported.
 * 
 *    Rev 1.77   Mar 22 2012 10:26:04   makuier
 * Time to live added.
 * 
 *    Rev 1.76   Mar 08 2012 14:43:44   makuier
 * Validate formatted access number
 * 
 *    Rev 1.75   Mar 07 2012 11:51:30   makuier
 * handle upstream bandwidth
 * 
 *    Rev 1.74   Feb 22 2012 15:01:18   makuier
 * Adapted to new XSD.
 * 
 *    Rev 1.73   Feb 17 2012 14:56:52   makuier
 * Handle open termination of DE.
 * 
 *    Rev 1.72   Feb 03 2012 13:27:00   makuier
 * Handle when only DE is in open order
 * 
 *    Rev 1.71   Feb 01 2012 17:19:08   makuier
 * Do not add the failed COM open orders to order list.
 * 
 *    Rev 1.70   Jan 27 2012 12:36:32   makuier
 * Use AsIs node for termination open order.
 * 
 *    Rev 1.69   Jan 19 2012 14:58:52   wlazlow
 * SPN-BKS-000117657, The empty productOfferingToBe nodes are filtered out.
 * 
 *    Rev 1.68   Dec 01 2011 12:29:34   makuier
 * - Populate order item type based on customer intention.
 * 
 *    Rev 1.67   Nov 21 2011 13:49:46   makuier
 * Do not duplicate local area code.
 * 
 *    Rev 1.66   Nov 16 2011 14:39:04   makuier
 * Bug fix
 * 
 *    Rev 1.65   Nov 15 2011 11:44:34   makuier
 * Jump over unsupported bundles.
 * 
 *    Rev 1.64   Nov 04 2011 11:08:26   makuier
 * All hardware types returned when request type is not CPD or ICS
 * 
 *    Rev 1.63   Oct 21 2011 15:54:20   makuier
 * Call SBUS service to retrieve open orders.
 * 
 *    Rev 1.62   Sep 01 2011 15:58:42   makuier
 * Initialize change end data for every bundle.
 * 
 *    Rev 1.61   Aug 26 2011 15:30:48   makuier
 * ITK 30916.  Seperate numeric and non-numeric part of street number
 * ITK 31028. poulate service billing name
 * 
 *    Rev 1.60   Aug 22 2011 15:13:48   makuier
 * ITK-30774 Allow VC customers
 * 
 *    Rev 1.59   Jul 22 2011 15:42:24   makuier
 * Put TVcenter tarif options into customer facing service
 * 
 *    Rev 1.58   Jul 18 2011 17:49:22   makuier
 * Delivery type corrected. 
 * 
 *    Rev 1.57   Jul 05 2011 17:56:28   makuier
 * Handle the special services for open orders.
 * 
 *    Rev 1.56   Jun 22 2011 15:37:22   makuier
 * V0002 added to voice list
 * 
 *    Rev 1.55   Jun 15 2011 16:05:18   makuier
 * corrected the exception parameters
 * 
 *    Rev 1.54   Jun 14 2011 12:46:56   makuier
 * - relate reference data to the software version.
 * 
 *    Rev 1.53   Jun 08 2011 16:17:28   makuier
 * Made service thread safe
 * 
 *    Rev 1.52   Jun 06 2011 17:35:54   makuier
 * Handle oracle date casting.
 * 
 *    Rev 1.51   May 25 2011 15:08:50   makuier
 * Ibatis maps date to timestamp.
 * 
 *    Rev 1.50   May 24 2011 12:55:20   makuier
 * Softened the validation.
 * 
 *    Rev 1.49   May 16 2011 17:36:28   makuier
 * Adapted to new XSDs
 * 
 *    Rev 1.48   May 13 2011 14:56:12   makuier
 * If main product is not subscribed use the end date from the other functions
 * 
 *    Rev 1.47   Apr 21 2011 13:40:02   makuier
 * Street number is paased to the query.
 * 
 *    Rev 1.46   Apr 01 2011 12:08:22   makuier
 * Allow EG hardware,
 * 
 *    Rev 1.45   Mar 30 2011 17:40:56   makuier
 * - Filter out rows with same customer number
 * 
 *    Rev 1.44   Mar 22 2011 13:16:32   makuier
 * Allow STB hardwares
 * 
 *    Rev 1.43   Mar 14 2011 16:25:50   makuier
 * remove the open order if the list is empty
 * 
 *    Rev 1.42   Mar 08 2011 16:13:52   makuier
 * BKS-0015 raised.
 * 
 *    Rev 1.41   Feb 28 2011 14:18:02   makuier
 * Check password case insensetive
 * 
 *    Rev 1.40   Feb 24 2011 14:55:22   makuier
 * corrected the list access
 * 
 *    Rev 1.39   Feb 18 2011 13:00:56   makuier
 * - Raise an error if no active account found for customer.
 * 
 *    Rev 1.38   Feb 16 2011 13:22:14   makuier
 * Disabled contract start date population.
 * 
 *    Rev 1.37   Feb 08 2011 16:20:16   makuier
 * Catch the time out exception and raise appropriet error.
 * 
 *    Rev 1.36   Feb 07 2011 17:13:16   makuier
 * Populate contractStartDate
 * 
 *    Rev 1.35   Jan 06 2011 09:45:22   makuier
 * Populate bundle id on SID.
 * 
 *    Rev 1.34   Jan 03 2011 14:16:00   makuier
 * Added support for service existance.
 * 
 *    Rev 1.33   Dec 28 2010 16:29:52   makuier
 * fixed hardware services for open orders.
 * 
 *    Rev 1.32   Dec 17 2010 16:28:00   makuier
 * removed I1356 and I1357 from the list of tarif options.
 * 
 *    Rev 1.31   Dec 09 2010 15:15:22   makuier
 * Corrected the path to TvCenter charging options.
 * 
 *    Rev 1.30   Dec 03 2010 17:53:24   makuier
 * Put TvCenter into SID ProductBundle
 * 
 *    Rev 1.29   Nov 05 2010 15:57:00   makuier
 * Only populate tariff options and international services for voice.
 * 
 *    Rev 1.28   Nov 03 2010 15:38:10   makuier
 * Changes for ITK-29421
 * 
 *    Rev 1.27   Oct 19 2010 08:53:44   makuier
 * Support when a block of ref data is missing.
 * 
 *    Rev 1.26   Oct 18 2010 08:56:58   makuier
 * removed the leading zero from area code
 * 
 *    Rev 1.25   Oct 07 2010 16:53:16   makuier
 * - adapt to ref data change.
 * - get hardware name from ref data.
 * 
 *    Rev 1.24   Oct 04 2010 12:50:10   makuier
 * FTTX added. Print only hardware type modem and IAD
 * 
 *    Rev 1.23   Sep 29 2010 13:42:44   makuier
 * Corrected error code.
 * 
 *    Rev 1.22   Sep 23 2010 18:24:48   makuier
 * Support for LTE added.
 * 
 *    Rev 1.21   Sep 14 2010 15:09:42   makuier
 * return contact information.
 * 
 *    Rev 1.20   Sep 01 2010 16:04:50   makuier
 * Jump over characteristic node if there is no ccb value
 * 
 *    Rev 1.19   Aug 31 2010 10:23:26   makuier
 * use refdata as outer loop.
 * 
 *    Rev 1.18   Aug 19 2010 16:31:06   makuier
 * Support for getting chatacteristic from child service added
 * 
 *    Rev 1.17   Aug 17 2010 14:42:16   makuier
 * Populate minimum duration.
 * 
 *    Rev 1.16   Aug 12 2010 10:47:28   makuier
 * If reference data type is M than set it to Modem.
 * 
 *    Rev 1.15   Aug 11 2010 18:29:58   makuier
 * populate AO flag.
 * 
 *    Rev 1.14   Aug 06 2010 11:02:18   makuier
 * do not default detached house if open order.
 * 
 *    Rev 1.13   Aug 05 2010 11:24:12   makuier
 * Support for detached house added.
 * 
 *    Rev 1.12   Jul 23 2010 16:17:08   makuier
 * Corrected misspelling.
 * 
 *    Rev 1.11   Jul 16 2010 16:58:46   makuier
 * Support for bar code search added.
 * 
 *    Rev 1.10   May 01 2010 16:13:18   makuier
 * Changes for CPCOM phase 2
 * 
 *    Rev 1.9   Jun 30 2010 16:20:16   makuier
 * Raise error if more than one customer returned for access number
 * 
...
import de.vodafone.esb.service.sbus.bks.bks_003.GetFNPCustomerDataRequest;
import de.vodafone.esb.service.sbus.bks.bks_003.GetFNPCustomerDataResponse;
...
@SoapEndpoint(soapAction = "/BKS-003/GetFNPCustomerData", context = "de.vodafone.esb.service.sbus.bks.bks_003", schema = "classpath:schema/BKS-003.xsd")
public class GetFNPCustomerDataImpl implements SoapOperation<GetFNPCustomerDataRequest, GetFNPCustomerDataResponse> {

    /** The logger. */
    private final static Log log = LogFactory.getLog(GetFNPCustomerDataImpl.class);
	...
	public ServiceResponseSoap<GetFNPCustomerDataResponse> invoke(ServiceObjectEndpoint<GetFNPCustomerDataRequest> serviceObject) 
		...
		try {
			...
			populateLogTable(e.getCode(), e.getText(), null, serviceObject.getCorrelationID(), 
					"GetFNPCustomerData,003", null, startTime, endTime, false,request);
	...
	private GetFNPCustomerDataResponse getSIDCustomerData(
		...
		if (!requestType.equals("GOL") && !requestType.equals("GAP")) {
		...
		if (!requestType.equals("GOL") && !requestType.equals("CID")) {
			...
			else if (request.getQueryLevel()== null || request.getQueryLevel().equals("customer"))
			...
			for (int i = 0;bundles!=null&& i < bundles.size(); i++) {
				...
				resp.getSid().getProductOfferingSubscription().get(i).setAoMastered(aoFlag);
		...
		if (!requestType.equals("CID") && !requestType.equals("GAP"))
			handleOpenOrders(dao,customerNumber,resp.getSid(),infoHolder,request.getRequestType(),theHelper);
		resp.getSid().setCustomerNumber(customerNumber);
		return resp;
	}
			...
			for (int i = 0; i < services.size(); i++) {
				...
				theHelper
						.setAttributeForPath(
								customerInformation,
								"set",
								"ProductOfferingSubscription.ProductOfferingOccurrence.ProductBundle.ProductBundleOrProduct.CustomerFacingService.Specification",
								serviceCode);
				theHelper
				.setAttributeForPath(
						customerInformation,
						"set",
						"ProductOfferingSubscription.ProductOfferingOccurrence.ProductBundle.ProductBundleOrProduct.CustomerFacingService.CharacteristicValue.Name",
						"Service Name");
				theHelper
				.setAttributeForPath(
						customerInformation,
						"set",
						"ProductOfferingSubscription.ProductOfferingOccurrence.ProductBundle.ProductBundleOrProduct.CustomerFacingService.CharacteristicValue.StringValue",
						serviceBillingName);
					...
					if(Arrays.asList(tariffOptionChar).contains(serviceCharCode)){
						...
						if(serviceCharCode.equals("V0200")){
							...
							theHelper
							        .setAttributeForPath(
									  customerInformation,
									  "set",
									  "ProductOfferingSubscription.ProductOfferingOccurrence.ProductBundle.ProductBundleOrProduct.CustomerFacingService.CharacteristicValue.StartDate",
									  converted);
						}
						...
						if(serviceCharCode.equals("V0231")){
							...
							.setAttributeForPath(
									customerInformation,
									"set",
									"ProductOfferingSubscription.ProductOfferingOccurrence.ProductBundle.ProductBundleOrProduct.CustomerFacingService.CharacteristicValue.Duration",
									duration/*converted*/);
							theHelper
							.setAttributeForPath(
									customerInformation,
									"set",
									"ProductOfferingSubscription.ProductOfferingOccurrence.ProductBundle.ProductBundleOrProduct.CustomerFacingService.CharacteristicValue.DurationUnit",
									"MONTH");
						}
						...
						if(serviceCharCode.equals("V0232")){
							...
							.setAttributeForPath(
									customerInformation,
									"set",
									"ProductOfferingSubscription.ProductOfferingOccurrence.ProductBundle.ProductBundleOrProduct.CustomerFacingService.CharacteristicValue.TerminationDate",
									converted);
						}
						...
						if(startDate != null && duration != null){
							...
							.setAttributeForPath(
									customerInformation,
									"set",
									"ProductOfferingSubscription.ProductOfferingOccurrence.ProductBundle.ProductBundleOrProduct.CustomerFacingService.CharacteristicValue.EndDate",
									converted);
				...
				if (hotSubs!=null) {
					...
					theHelper
							.setAttributeForPath(
									customerInformation,
									"set",
									"ProductOfferingSubscription.ProductOfferingOccurrence.ProductBundle.ProductBundleOrProduct.CustomerFacingService.CharacteristicValue.BooleanValue",
									hotSubs);
				}
			}
		}
	...
	private boolean populateConfiguredValues(GetFNPCustomerDataDAO dao,
		...
		while (keyiter.hasNext()){
			...
			for (int j = 0; j < charPath.get(refCharCode).size(); j++) {
				...
				if (introVersion != null && introVersion.compareTo("BKS-003") > 0 )
					continue;
	...
	private String populateTableData(GetFNPCustomerDataDAO dao,
		...
		if (contract != null && contract.size() > 0) {
			...
			if(bOpenOrder){
				...
				int lastIndex = customerInformation.getProductOfferingSubscription().size() -1;
				ProductOfferingSubscription currentSubscription = customerInformation.getProductOfferingSubscription().get(lastIndex);
				...
				if (Arrays.asList(mainServices).contains(serviceCode) ||  infoHolder.changeEndDate()){
					...
					currentSubscription.setSignDate(signDate);
...
/*
			if (!bOpenOrder){
				String startDateAsStr = contract.get(0).get("TERM_START_DATE").toString();
				CalendarDate startDate = theHelper.convertToDate(startDateAsStr);
				int lastOccurance = currentSubscription.getProductOfferingOccurrence().size() -1;
				currentSubscription.getProductOfferingOccurrence().get(lastOccurance).setContractStartDate(startDate);
			}
*/
		} else {
	...
	ArrayList<HashMap<String, Object>> getCustomerList(GetFNPCustomerDataDAO dao,GetFNPCustomerDataRequest request, FNPInformationHolder infoHolder, String requestType, BksHelper theHelper) throws Exception{
		...
		if (accnum != null) {
			...
			if (custList!=null && custList.size() > 0) {
				...
				String[] excReqTypes = {"GAP", "CID", "GOL"};
				if (!Arrays.asList(excReqTypes).contains(request.getRequestType())){
					if (dateOfBirth != null && bd != null && 
							!dateOfBirth.equals(CalendarDate.from(bd.toString(), "yyyy-MM-dd"))){
