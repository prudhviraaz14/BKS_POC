/*
    $Header:   //PVCS_BKS/archives/BKS/BKS/src/net/arcor/bks/requesthandler/GetFNPCustomerData3Impl.java-arc   1.76   Sep 17 2018 14:37:58   makuier  $

    $Log:   //PVCS_BKS/archives/BKS/BKS/src/net/arcor/bks/requesthandler/GetFNPCustomerData3Impl.java-arc  $
 * 
 *    Rev 1.76   Sep 17 2018 14:37:58   makuier
 * Support for Fibre services added
 * 
 *    Rev 1.75   Oct 27 2017 14:05:26   makuier
 * Added BIR to not supported bundle types.
 * 
 *    Rev 1.74   Jul 27 2017 12:48:24   makuier
 * Use service billing name fro volume cap
 * 
 *    Rev 1.73   Jun 08 2017 07:50:46   makuier
 * Return volume caps
 * 
 *    Rev 1.72   Jan 19 2017 15:51:08   makuier
 * Skip Intro for SID services
 * 
 *    Rev 1.71   Oct 28 2016 18:42:32   makuier
 * - trigger generic ref data for HW
 * 
 *    Rev 1.70   Sep 23 2016 12:28:56   makuier
 * Populate default value of 0 if the tariff option does not have any duration characteristic (V0231)
 * 
 *    Rev 1.69   Sep 21 2016 07:24:46   makuier
 * Consider product code in the address key.
 * 
 *    Rev 1.68   Jul 07 2016 15:42:24   lejam
 * RMS-152753 PPM-196371 DSL Portfolio 2016 - replaced service code by "minimumDuration" in tvcenteropions 
 * 
 *    Rev 1.67   Jul 07 2016 12:41:02   gaurav.verma
 * Add the new node ContractualObligation 
 * 
 *    Rev 1.66   Jun 30 2016 09:17:32   gaurav.verma
 * RMS-152753 PPM-196371 DSL Portfolio 2016 - Changes for TariffOptionList and TvCenterOptionList
 * 
 *    Rev 1.65   Dec 03 2015 21:32:58   sibani.panda
 * RMS 149627 PPM-183594 - Changed Error code and text in case of customer of a service provider
 * 
 *    Rev 1.64   Sep 15 2015 15:49:58   makuier
 * Support for rented hardware added.
 * 
 *    Rev 1.63   Jun 09 2015 16:48:50   sibani.panda
 * RMS-142618: added method populateCustomerPermissions for populating customer permissions details from new tables
 * 
 *    Rev 1.62   Apr 02 2014 09:28:34   makuier
 * Check the validation row.
 * 
 *    Rev 1.61   Mar 17 2014 10:02:20   makuier
 * Separate email validation.
 * 
 *    Rev 1.60   Mar 06 2014 09:22:42   makuier
 * Do not populate EmailValidationResult if any mandatory sub node is missing
 * 
 *    Rev 1.59   Jan 22 2014 12:02:38   makuier
 * Populate mandate node only  if both mandatory sub-nodes are populated.
 * 
 *    Rev 1.58   Oct 10 2013 12:31:38   makuier
 * Populate bank node only  if both mandatory sub-nodes are populated.
 * 
 *    Rev 1.57   Jun 12 2013 11:17:18   makuier
 * Changed the serializer
 * 
 *    Rev 1.56   Oct 12 2012 13:58:38   makuier
 * Added V0012 to the list of services.
 * 
 *    Rev 1.55   Aug 22 2012 16:08:54   makuier
 * - Do not populate hot subscription if the characteristic is not populated
 * 
 *    Rev 1.54   Jul 19 2012 16:57:08   makuier
 * Populate Contract end date
 * 
 *    Rev 1.53   Jun 22 2012 14:05:34   makuier
 * Populate log table
 * 
 *    Rev 1.52   May 04 2012 13:49:06   makuier
 * Do not raise BKS-00026 for DSL-R products
 * 
 *    Rev 1.51   Apr 19 2012 10:23:32   makuier
 * Allow conversion method for access numbers.
 * 
 *    Rev 1.50   Apr 13 2012 11:11:02   makuier
 * I1351 added to the list of TV add-ons
 * 
 *    Rev 1.49   Mar 29 2012 15:14:56   makuier
 * remove duplicates from customer list
 * 
 *    Rev 1.48   Mar 26 2012 12:25:00   makuier
 * Parsing phone number in contact medium supported.
 * 
 *    Rev 1.47   Mar 22 2012 10:26:04   makuier
 * Time to live added.
 * 
 *    Rev 1.46   Mar 08 2012 14:43:46   makuier
 * Validate formatted access number
 * 
 *    Rev 1.45   Mar 07 2012 11:51:32   makuier
 * handle upstream bandwidth
 * 
 *    Rev 1.44   Feb 22 2012 15:01:20   makuier
 * Adapted to new XSD.
 * 
 *    Rev 1.43   Feb 17 2012 14:56:52   makuier
 * Handle open termination of DE.
 * 
 *    Rev 1.42   Feb 03 2012 13:27:00   makuier
 * Handle when only DE is in open order
 * 
 *    Rev 1.41   Feb 01 2012 17:19:08   makuier
 * Do not add the failed COM open orders to order list.
 * 
 *    Rev 1.40   Jan 27 2012 12:36:32   makuier
 * Use AsIs node for termination open order.
 * 
 *    Rev 1.39   Jan 19 2012 14:58:52   wlazlow
 * SPN-BKS-000117657, The empty productOfferingToBe nodes are filtered out.
 * 
 *    Rev 1.38   Dec 01 2011 12:29:34   makuier
 * - Populate order item type based on customer intention.
 * 
 *    Rev 1.37   Nov 21 2011 13:49:46   makuier
 * Do not duplicate local area code.
 * 
 *    Rev 1.36   Nov 16 2011 14:39:04   makuier
 * Bug fix
 * 
 *    Rev 1.35   Nov 15 2011 11:44:34   makuier
 * Jump over unsupported bundles.
 * 
 *    Rev 1.34   Nov 04 2011 11:08:28   makuier
 * All hardware types returned when request type is not CPD or ICS
 * 
 *    Rev 1.33   Oct 21 2011 15:54:20   makuier
 * Call SBUS service to retrieve open orders.
 * 
 *    Rev 1.32   Oct 20 2011 13:33:04   makuier
 * Do not filter the last customer out in case of parsing error.
 * 
 *    Rev 1.31   Sep 01 2011 15:58:42   makuier
 * Initialize change end data for every bundle.
 * 
 *    Rev 1.30   Aug 26 2011 15:31:42   makuier
 * ITK 30916.  Seperate numeric and non-numeric part of street number
 * ITK 31028. poulate service billing name
 * 
 *    Rev 1.29   Aug 18 2011 14:03:56   makuier
 * removed AO filtering when the bundle id received.
 * 
 *    Rev 1.28   Jul 22 2011 15:42:24   makuier
 * Put TVcenter tarif options into customer facing service
 * 
 *    Rev 1.27   Jul 18 2011 17:49:20   makuier
 * Delivery type corrected. 
 * 
 *    Rev 1.26   Jul 07 2011 11:50:32   makuier
 * Search by bundle id added.
 * 
 *    Rev 1.25   Jul 05 2011 17:56:30   makuier
 * Handle the special services for open orders.
 * 
 *    Rev 1.24   Jun 22 2011 15:37:22   makuier
 * V0002 added to voice list
 * 
 *    Rev 1.23   Jun 14 2011 12:46:56   makuier
 * - relate reference data to the software version.
 * 
 *    Rev 1.22   Jun 03 2011 16:06:22   makuier
 * Refactored for malti threading
 * 
 *    Rev 1.21   May 25 2011 15:08:50   makuier
 * Ibatis maps date to timestamp.
 * 
 *    Rev 1.20   May 24 2011 12:55:20   makuier
 * Softened the validation.
 * 
 *    Rev 1.19   May 16 2011 17:36:28   makuier
 * Adapted to new XSDs
 * 
 *    Rev 1.18   May 13 2011 15:23:36   makuier
 * If main product is not subscribed use the end date from the other functions
 * 
 *    Rev 1.17   May 04 2011 15:07:32   makuier
 * RCO behaves like GAP
 * 
 *    Rev 1.16   Apr 21 2011 13:40:02   makuier
 * Street number is paased to the query.
 * 
 *    Rev 1.15   Apr 01 2011 12:08:22   makuier
 * Allow EG hardware,
 * 
 *    Rev 1.14   Mar 22 2011 13:16:34   makuier
 * Allow STB hardwares
 * 
 *    Rev 1.13   Mar 14 2011 16:25:50   makuier
 * remove the open order if the list is empty
 * 
 *    Rev 1.12   Feb 28 2011 14:18:02   makuier
 * Check password case insensetive
 * 
 *    Rev 1.11   Feb 18 2011 12:31:54   makuier
 * remove the duplicate customers
 * 
 *    Rev 1.10   Feb 08 2011 16:20:16   makuier
 * Catch the time out exception and raise appropriet error.
 * 
 *    Rev 1.9   Jan 06 2011 09:45:22   makuier
 * Populate bundle id on SID.
 * 
 *    Rev 1.8   Jan 03 2011 14:17:38   makuier
 * Added support for server existance.
 * Fuzzy seach only in ICP or CID mode
 * 
 *    Rev 1.7   Dec 28 2010 16:27:32   makuier
 * Use barcode for fetching products only if access number and customer number are not provided.
 * 
 *    Rev 1.6   Dec 27 2010 16:20:38   makuier
 * Misc. fixes.
 * 
 *    Rev 1.5   Dec 17 2010 18:14:42   makuier
 * Support for fuzzy search added.
 * 
 *    Rev 1.4   Dec 09 2010 15:15:22   makuier
 * Corrected the path to TvCenter charging options.
 * 
 *    Rev 1.3   Dec 03 2010 17:53:24   makuier
 * Put TvCenter into SID ProductBundle
 * 
 *    Rev 1.2   Nov 05 2010 15:57:00   makuier
 * Only populate tariff options and international services for voice.
 * 
 *    Rev 1.1   Oct 18 2010 08:56:58   makuier
 * removed the leading zero from area code
 * 
 *    Rev 1.0   Oct 15 2010 16:06:48   makuier
 * Initial revision.
 * 
*/
...
import de.vodafone.esb.service.sbus.bks.bks_004.GetFNPCustomerDataRequest;
import de.vodafone.esb.service.sbus.bks.bks_004.GetFNPCustomerDataResponse;
...
@SoapEndpoint(soapAction = "/BKS-004/GetFNPCustomerData", context = "de.vodafone.esb.service.sbus.bks.bks_004", schema = "classpath:schema/BKS-004.xsd")
public class GetFNPCustomerData3Impl implements SoapOperation<GetFNPCustomerDataRequest, GetFNPCustomerDataResponse> {

    /** The logger. */
    private final static Log log = LogFactory.getLog(GetFNPCustomerData3Impl.class);
	...
	public ServiceResponseSoap<GetFNPCustomerDataResponse> invoke(ServiceObjectEndpoint<GetFNPCustomerDataRequest> serviceObject) 
		...
		try {
			output = getSIDCustomerData(dao,request, null,theHelper);
		} catch (BksDataException e) {
			log.error(e.getText());
	        long endTime = System.currentTimeMillis();
			populateLogTable(e.getCode(), e.getText(), null, serviceObject.getCorrelationID(), 
					"GetFNPCustomerData,004", null, startTime, endTime, false,request);
	...
	public CustomerInformation getCustomerInfoByBundle(String bundleId, String reqType) throws  Exception {
		BksHelper theHelper = new BksHelper();
		GetFNPCustomerDataDAO dao = (GetFNPCustomerDataDAO) DatabaseClient.getBksDataAccessObject(null, "GetFNPCustomerDataDAO");
		GetFNPCustomerDataRequest request = new GetFNPCustomerDataRequest();
		request.setRequestType(reqType);
		request.setQueryLevel("accessNumber");
		GetFNPCustomerDataResponse output = new GetFNPCustomerDataResponse();
		try {
			output = getSIDCustomerData(dao,request, bundleId, theHelper);
			ExperimentalXmlProcessor xmlProc = ExperimentalXmlProcessor.getInstance();
			xmlProc.serialize(output, "schema/BKS-004.xsd", "de.vodafone.esb.service.sbus.bks.bks_004");
		} finally {
			try {
	...
	private GetFNPCustomerDataResponse getSIDCustomerData(
			GetFNPCustomerDataDAO dao, GetFNPCustomerDataRequest request,String inputBundleId,
		...
		if (inputBundleId== null)
			custList = getCustomerList(dao, request,infoHolder,requestType, theHelper);
		else
			custList = dao.getCustomerForBundleId(inputBundleId);
	...
	private boolean populateConfiguredValues(GetFNPCustomerDataDAO dao,
		...
		while (keyiter.hasNext()){
			...
			for (int j = 0; j < charPath.get(refCharCode).size(); j++) {
				...
				if (introVersion != null && introVersion.compareTo("BKS-004") > 0 )
					continue;
	...
	ArrayList<HashMap<String, Object>> getCustomerList(GetFNPCustomerDataDAO dao,GetFNPCustomerDataRequest request, FNPInformationHolder infoHolder, String requestType, BksHelper theHelper) throws Exception{
		...
		for (int i = 0; i < custList.size(); i++) {
			...
			if (barcode == null	&& (classification.startsWith("A") || 
				classification.startsWith("B")|| classification.startsWith("C") || 
				classification.equals("VC"))) {
				if (custList.size()==1){
					String errorText = "Non supported customer classification";
					String errorCode = "BKSCOM-ERROR-000022";
					throw new BksDataException(errorCode,errorText);
	...
	private boolean doesCustomerParse(CustomerInformation customerInformation) {
		...
		try {
			ExperimentalXmlProcessor xmlProc = ExperimentalXmlProcessor
					.getInstance();
			xmlProc.serialize(tmpOut, "schema/BKS-004.xsd",
					"de.vodafone.esb.service.sbus.bks.bks_004");
		} catch (Exception e) {
			return false;
		}
		return true;
