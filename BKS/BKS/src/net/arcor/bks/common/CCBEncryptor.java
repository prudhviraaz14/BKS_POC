/*
    $Header:   //PVCS_BKS/archives/BKS/BKS/src/net/arcor/bks/common/CCBEncryptor.java-arc   1.0   Aug 10 2007 18:01:22   makuier  $

    $Log:   //PVCS_BKS/archives/BKS/BKS/src/net/arcor/bks/common/CCBEncryptor.java-arc  $
 * 
...
public final class CCBEncryptor extends BlowfishECB {
     ...
     * @param key   the encryption key to use.
     */
    public CCBEncryptor(String key) throws Exception {
        super(key.getBytes());
        if (key == null) {
     ...
     */
    private static byte[] decryptForCcb(byte[] text) throws Exception {
        if (text == null) {
            return null;
        }
        ...
        if (((int) (length / 2)) * 2 != length) {
            throw new Exception("The length of array 'text' is not "
                + "dividable by 2");
        }
