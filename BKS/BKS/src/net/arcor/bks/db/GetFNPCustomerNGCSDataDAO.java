...
public interface GetFNPCustomerNGCSDataDAO extends BksDataAccessObject{
	...
	ArrayList<HashMap<String, Object>> getChildServices(String parentServSubsId, String serviceType)throws Exception;
	...
	ArrayList<HashMap<String, Object>> getUnbundledProducts(String customerNumber)throws Exception;
	ArrayList<HashMap<String, Object>> getCustomerByServiceSubscription(String servSubsId)throws Exception;
	ArrayList<HashMap<String, Object>> getDocumentPatternForAccount(String accountNumber)throws Exception;
	ArrayList<HashMap<String, Object>> getAccountDataByAccountNumber(String accountNumber)throws Exception;
	ArrayList<HashMap<String, Object>> getDocumentRecipientForAccount(String accountNumber)throws Exception;
	ArrayList<HashMap<String, Object>> getChildCustomers(String customerNumber)throws Exception;
	ArrayList<HashMap<String, Object>> getGuidingRules(String servSubsId)throws Exception;
	ArrayList<HashMap<String, Object>> getCustomerDataByTasi(String tasi)throws Exception;
